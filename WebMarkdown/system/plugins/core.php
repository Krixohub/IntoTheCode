...
class YellowPage
{
	...
	function parseMeta($pageError = "")
	{
		...
		if(!is_null($this->rawData))
		{
            ...
            // Add configurations here /Møhl
			$this->set("keywords", $this->yellow->config->get("keywords"));
	...
	function parseContent()
	{
		if(!is_object($this->parser))
		{
			...
			{
				$this->set("keywords", $this->yellow->toolbox->createTextKeywords($this->get("keywords"), 10));
			}
