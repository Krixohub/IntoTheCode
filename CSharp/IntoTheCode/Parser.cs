...
namespace IntoTheCode
{
    ...
    public class Parser
    {
        ...
        private void SetGrammar(string Grammar)
        {
            ...
            if (buffer.Status.Error != null || !GrammarModelBuilder.BuildRules(this, grammarDoc, buffer.Status))
            {
        ...
        internal CodeDocument ParseString(TextBuffer buffer)
        {
            ...
            if (!GrammarModelBuilder.InitializeGrammar(this, procesRules, buffer.Status))
                return null;
