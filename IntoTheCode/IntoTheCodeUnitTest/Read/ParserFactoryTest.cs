...
namespace Read
{
    ...
    public class ParserFactoryTest
    {
        ...
        public void BuildError()
        {
            ...
            // no pb11 error
            Util.ParserBuildError("aa = ab; ab = aa | identifier;");
            Util.ParserBuildError("aa = ab; ab = identifier | aa;");
