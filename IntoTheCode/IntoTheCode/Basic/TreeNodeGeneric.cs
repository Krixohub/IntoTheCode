...
namespace IntoTheCode.Basic
{
    ...
    public abstract class TreeNodeG<TElement> where TElement: TreeNodeG<TElement>// : NotifyChanges
    {
        /// <summary>Creator for <see cref="TreeNodeG"/>.</summary>
        /// <exclude/>
        internal TreeNodeG(IList<TElement> elements)
        {
            if (elements == null)
                return;
        ...
        /// <summary>Creator for <see cref="TreeNodeG"/>.</summary>
        /// <exclude/>
        internal TreeNodeG(params TElement[] elements)
        {
